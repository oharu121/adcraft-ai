  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="md" className="backdrop-blur-sm">
      ...
      <div className="bg-gray-900/95 backdrop-blur-md p-4 sm:p-6 space-y-4 sm:space-y-6 max-h-[60vh] sm:max-h-[70vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-center gap-2 sm:gap-4">
              ...
              <div className="flex-1 relative flex items-center h-10 sm:h-12">
                ...
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-3/8">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center shadow-lg border-2 border-white/20 animate-bounce">
        ...
        {isProcessing && (
          <div className="bg-purple-900/30 border border-purple-500/30 rounded-lg p-3 sm:p-4 flex items-center gap-2 sm:gap-3">
            <div className="w-4 h-4 sm:w-5 sm:h-5 border-2 border-purple-400 border-t-transparent rounded-full animate-spin"></div>
            <span className="text-purple-200 text-sm sm:text-base font-medium">
