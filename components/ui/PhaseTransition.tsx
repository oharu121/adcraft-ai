...
const PHASE_TITLES: Record<AppPhase, string> = {
  ...
  "zara-production": "Video Production",
  completed: "Complete",
};
...
export default function PhaseTransition({
  ...
  return (
    ...
    >
      <div
        className={`bg-gradient-to-br from-purple-900/90 via-purple-800/80 to-pink-900/90 backdrop-blur-md rounded-xl border border-purple-500/30 p-8 max-w-md w-full mx-4 transform transition-all duration-500 ${
          ...
          <div className="text-center space-y-6">
            ...
            <div className="flex items-center justify-center space-x-4">
              ...
              <div className="flex flex-col items-center space-y-2">
                ...
                <span className="text-sm text-purple-200 font-medium">{PHASE_TITLES[from]}</span>
              </div>
              ...
              <div className="flex flex-col items-center space-y-2">
                ...
                <span className="text-sm text-pink-200 font-medium">{PHASE_TITLES[to]}</span>
              </div>
            </div>
