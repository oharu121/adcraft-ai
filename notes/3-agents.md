...
Agent 3: Video Producer (Let's say "Zara")
...
2. David (Creative Director): "I'll make it visually stunning"
    ...
    - Visual style → Scene composition

3. Zara (Video Producer): "I'll bring it all together perfectly"
...
- Zara: "Finally, let's produce the perfect commercial..."
...
- Zara: Focus on production decisions and final optimization
