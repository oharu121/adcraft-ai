...
description: Project analyst and documentation architect. Specializes in analyzing existing codebases and creating core project guideline files (`.ai-rules/`). Must be used when project initialization, architecture analysis, creation of project standards, or technology stack analysis is required.
model: sonnet
color: blue
---
