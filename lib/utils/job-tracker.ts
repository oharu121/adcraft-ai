import { FirestoreService, VideoJob } from "../services/firestore";
import { VeoService, VideoJobStatus } from "../services/veo";
...
export class JobTracker {
  ...
  public async getJobMetrics(): Promise<JobMetrics> {
    try {
      ...
      const totalJobs =
        pendingJobs.length + processingJobs.length + completedJobs.length + failedJobs.length;
